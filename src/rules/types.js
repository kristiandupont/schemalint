    ...
    const validator = ({ name: tableName }) => ({
      ...
      if (
        ...
        report({
          ...
          suggestedMigration: `ALTER TABLE "${tableName}" ALTER "${columnName}" DROP DEFAULT;
DROP SEQUENCE "${sequenceName}";
ALTER TABLE "${tableName}" ALTER "${columnName}" ADD GENERATED BY DEFAULT AS IDENTITY;
SELECT setval('"${sequenceName}"', max("${columnName}")) FROM "${tableName}";`,
        });
      }
    };
    schemaObject.tables.forEach((table) =>
