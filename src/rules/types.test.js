    ...
    it('one table, timetamp columns has errors', () => {
      ...
      expect(mockReporter).toBeCalledWith(
        expect.objectContaining({
          ...
          suggestedMigration:
            'ALTER TABLE "one_table" ALTER COLUMN "bad_column" TYPE TIMESTAMPTZ;',
        })
      );
      expect(mockReporter).toBeCalledWith(
        expect.objectContaining({
          ...
          message: 'Prefer TIMESTAMPTZ to type TIMESTAMP',
          suggestedMigration:
            'ALTER TABLE "one_table" ALTER COLUMN "bad_column2" TYPE TIMESTAMPTZ;',
        })
      );
    });
    ...
    it('multiple tables with multiple varchar columns has multiple errors', () => {
      ...
      expect(mockReporter).toBeCalledWith(
        expect.objectContaining({
          ...
          message: 'Prefer TIMESTAMPTZ to type TIMESTAMP',
          suggestedMigration:
            'ALTER TABLE "three_table" ALTER COLUMN "bad_column3" TYPE TIMESTAMPTZ;',
        })
      );
    });
  });
